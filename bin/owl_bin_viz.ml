...
module CGraph_S = Owl_computation_engine.Make_Graph (Owl_computation_cpu_device.Make (Owl_algodiff_baseops.S))

module CGraph_D = Owl_computation_engine.Make_Graph (Owl_computation_cpu_device.Make (Owl_algodiff_baseops.D))
