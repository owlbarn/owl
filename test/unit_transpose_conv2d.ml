...
let fun_ctb00 () =
  Alcotest.(check bool) "fun_ctb00" true (To_test_transpose_conv2d_backward.fun00 ())


let fun_ctb01 () =
  Alcotest.(check bool) "fun_ctb01" true (To_test_transpose_conv2d_backward.fun01 ())


let fun_ctb02 () =
  Alcotest.(check bool) "fun_ctb02" true (To_test_transpose_conv2d_backward.fun02 ())


let fun_ctb03 () =
  Alcotest.(check bool) "fun_ctb03" true (To_test_transpose_conv2d_backward.fun03 ())


let fun_ctb04 () =
  Alcotest.(check bool) "fun_ctb04" true (To_test_transpose_conv2d_backward.fun04 ())


let fun_ctb05 () =
  Alcotest.(check bool) "fun_ctb05" true (To_test_transpose_conv2d_backward.fun05 ())


let fun_ctb06 () =
  Alcotest.(check bool) "fun_ctb06" true (To_test_transpose_conv2d_backward.fun06 ())


let fun_ctb07 () =
  Alcotest.(check bool) "fun_ctb07" true (To_test_transpose_conv2d_backward.fun07 ())


let fun_ctb08 () =
  Alcotest.(check bool) "fun_ctb08" true (To_test_transpose_conv2d_backward.fun08 ())


let fun_ctb09 () =
  Alcotest.(check bool) "fun_ctb09" true (To_test_transpose_conv2d_backward.fun09 ())


let fun_ctb10 () =
  Alcotest.(check bool) "fun_ctb10" true (To_test_transpose_conv2d_backward.fun10 ())


let fun_ctb11 () =
  Alcotest.(check bool) "fun_ctb11" true (To_test_transpose_conv2d_backward.fun11 ())


let fun_ctb12 () =
  Alcotest.(check bool) "fun_ctb12" true (To_test_transpose_conv2d_backward.fun12 ())


let fun_ctb13 () =
  Alcotest.(check bool) "fun_ctb13" true (To_test_transpose_conv2d_backward.fun13 ())


let fun_ctb14 () =
  Alcotest.(check bool) "fun_ctb14" true (To_test_transpose_conv2d_backward.fun14 ())


let fun_ctb15 () =
  Alcotest.(check bool) "fun_ctb15" true (To_test_transpose_conv2d_backward.fun15 ())


let test_set =
  [ "fun_ctf00", `Slow, fun_ctf00; "fun_ctf01", `Slow, fun_ctf01
  ; "fun_ctf02", `Slow, fun_ctf02; "fun_ctf03", `Slow, fun_ctf03
  ; "fun_ctf04", `Slow, fun_ctf04; "fun_ctf05", `Slow, fun_ctf05
  ; "fun_ctf06", `Slow, fun_ctf06; "fun_ctf07", `Slow, fun_ctf07
  ; "fun_ctf08", `Slow, fun_ctf08; "fun_ctb00", `Slow, fun_ctb00
