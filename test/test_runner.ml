...
let () =
  Alcotest.run
    "Owl"
    [ "stats_rvs", Unit_stats_rvs.test_set; "stats", Unit_stats.test_set
    ; "maths", Unit_maths.test_set; "graph", Unit_graph.test_set
    ; "multimap", Unit_multimap.test_set; "algodiff diff", Unit_algodiff_diff.test_set
    ...
    ; "lazy evaluation", Unit_lazy.test_set; "linear algebra", Unit_linalg.test_set
    ; "slicing basic", Unit_slicing_basic.test_set
    ; "slicing fancy", Unit_slicing_fancy.test_set; "pooling2d", Unit_pool2d.test_set
    ; "pooling3d", Unit_pool3d.test_set; "conv2d", Unit_conv2d.test_set
    ...
    ; "upsampling", Unit_upsampling.test_set; "learning rate", Unit_learning_rate.test_set
    ...
    ; "base: conv2d", Unit_base_conv2d.test_set; "base: conv3d", Unit_base_conv3d.test_set
    ; "base: upsampling", Unit_base_upsampling.test_set; "base: view", Unit_view.test_set
