module Make (Types : Owl_algodiff_types_sig.Sig) = struct
  ...
  and op_sipo a ff fd df r =
    ...
    | DR (ap, _, _, _, ai, _) ->
      ...
      ( DR (cp1, aa1_ref, r (a, (cp1_ref, cp2_ref), (aa1_ref, aa2_ref)), ref 0, ai, tracker)
      , DR (cp2, aa2_ref, r (a, (cp1_ref, cp2_ref), (aa1_ref, aa2_ref)), ref 0, ai, tracker) )
    | ap -> ff ap
  ...
  and op_sito a ff fd df r =
    ...
    | DR (ap, _, _, _, ai, _) ->
      ...
      let tracker = ref 0 in
      ( DR (cp1, aa1_ref, r (a, (cp1_ref, cp2_ref, cp3_ref), (aa1_ref, aa2_ref, aa3_ref)), ref 0, ai, tracker)
      , DR (cp2, aa2_ref, r (a, (cp1_ref, cp2_ref, cp3_ref), (aa1_ref, aa2_ref, aa3_ref)), ref 0, ai, tracker)
      , DR (cp3, aa3_ref, r (a, (cp1_ref, cp2_ref, cp3_ref), (aa1_ref, aa2_ref, aa3_ref)), ref 0, ai, tracker) )
    | ap -> ff ap
  ...
  and op_siao a ff fd df r =
    ...
    | DR (ap, _, _, _, ai, _) ->
      ...
      Array.map2
        (fun cp aa_ref -> DR (cp, aa_ref, r (a, cp_arr_ref, aa_ref_arr), ref 0, ai, tracker))
        cp_arr
        aa_ref_arr
    | ap -> ff ap
