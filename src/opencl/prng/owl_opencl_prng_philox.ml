...
external _create_streams
  :  int
  -> _ CI.fatptr
  -> _ CI.fatptr
  -> _ CI.fatptr
  -> CI.voidp
  = "owl_clrng_philox_create_streams_stub"

external _destroy_streams : _ CI.fatptr -> unit = "owl_clrng_philox_destroy_streams_stub"

external _create_over_streams
  :  int
  -> _ CI.fatptr
  -> _ CI.fatptr
  -> unit
  = "owl_clrng_philox_create_over_streams_stub"

external _rewind_streams
  :  Unsigned.size_t
  -> _ CI.fatptr
  -> unit
  = "owl_clrng_philox_rewind_streams_stub"
