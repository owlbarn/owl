...
let _neg_one : type a b. (a, b) kind -> a = function
  | Float32 -> -1.0 | Complex32 -> Complex.({re=(-1.); im=0.})
  | Float64 -> -1.0 | Complex64 -> Complex.({re=(-1.); im=0.})
  | Int8_signed -> -1 | Int8_unsigned -> -1
  | Int16_signed -> -1 | Int16_unsigned -> -1
  | Int32 -> -1l | Int64 -> -1L
  | Int -> -1 | Nativeint -> -1n
...
external owl_real_float_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_float_less"
external owl_real_double_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_double_less"
external owl_complex_float_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_float_less"
external owl_complex_double_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_double_less"
...
external owl_real_float_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_float_greater"
external owl_real_double_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_double_greater"
external owl_complex_float_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_float_greater"
external owl_complex_double_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_double_greater"
...
external owl_real_float_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_float_less_equal"
external owl_real_double_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_double_less_equal"
external owl_complex_float_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_float_less_equal"
external owl_complex_double_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_double_less_equal"
...
external owl_real_float_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_float_greater_equal"
external owl_real_double_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "real_double_greater_equal"
external owl_complex_float_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_float_greater_equal"
external owl_complex_double_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> int = "complex_double_greater_equal"
...
external owl_real_float_is_zero : int -> ('a, 'b) owl_arr -> int = "real_float_is_zero"
external owl_real_double_is_zero : int -> ('a, 'b) owl_arr -> int = "real_double_is_zero"
external owl_complex_float_is_zero : int -> ('a, 'b) owl_arr -> int = "complex_float_is_zero"
external owl_complex_double_is_zero : int -> ('a, 'b) owl_arr -> int = "complex_double_is_zero"
...
external owl_real_float_is_positive : int -> ('a, 'b) owl_arr -> int = "real_float_is_positive"
external owl_real_double_is_positive : int -> ('a, 'b) owl_arr -> int = "real_double_is_positive"
external owl_complex_float_is_positive : int -> ('a, 'b) owl_arr -> int = "complex_float_is_positive"
external owl_complex_double_is_positive : int -> ('a, 'b) owl_arr -> int = "complex_double_is_positive"
...
external owl_real_float_is_negative : int -> ('a, 'b) owl_arr -> int = "real_float_is_negative"
external owl_real_double_is_negative : int -> ('a, 'b) owl_arr -> int = "real_double_is_negative"
external owl_complex_float_is_negative : int -> ('a, 'b) owl_arr -> int = "complex_float_is_negative"
external owl_complex_double_is_negative : int -> ('a, 'b) owl_arr -> int = "complex_double_is_negative"
...
external owl_real_float_is_nonnegative : int -> ('a, 'b) owl_arr -> int = "real_float_is_nonnegative"
external owl_real_double_is_nonnegative : int -> ('a, 'b) owl_arr -> int = "real_double_is_nonnegative"
external owl_complex_float_is_nonnegative : int -> ('a, 'b) owl_arr -> int = "complex_float_is_nonnegative"
external owl_complex_double_is_nonnegative : int -> ('a, 'b) owl_arr -> int = "complex_double_is_nonnegative"
...
external owl_real_float_is_nonpositive : int -> ('a, 'b) owl_arr -> int = "real_float_is_nonpositive"
external owl_real_double_is_nonpositive : int -> ('a, 'b) owl_arr -> int = "real_double_is_nonpositive"
external owl_complex_float_is_nonpositive : int -> ('a, 'b) owl_arr -> int = "complex_float_is_nonpositive"
external owl_complex_double_is_nonpositive : int -> ('a, 'b) owl_arr -> int = "complex_double_is_nonpositive"
...
external owl_real_float_is_normal : int -> ('a, 'b) owl_arr -> int = "real_float_is_normal"
external owl_real_double_is_normal : int -> ('a, 'b) owl_arr -> int = "real_double_is_normal"
external owl_complex_float_is_normal : int -> ('a, 'b) owl_arr -> int = "complex_float_is_normal"
external owl_complex_double_is_normal : int -> ('a, 'b) owl_arr -> int = "complex_double_is_normal"
...
external owl_real_float_not_nan : int -> ('a, 'b) owl_arr -> int = "real_float_not_nan"
external owl_real_double_not_nan : int -> ('a, 'b) owl_arr -> int = "real_double_not_nan"
external owl_complex_float_not_nan : int -> ('a, 'b) owl_arr -> int = "complex_float_not_nan"
external owl_complex_double_not_nan : int -> ('a, 'b) owl_arr -> int = "complex_double_not_nan"
...
external owl_real_float_not_inf : int -> ('a, 'b) owl_arr -> int = "real_float_not_inf"
external owl_real_double_not_inf : int -> ('a, 'b) owl_arr -> int = "real_double_not_inf"
external owl_complex_float_not_inf : int -> ('a, 'b) owl_arr -> int = "complex_float_not_inf"
external owl_complex_double_not_inf : int -> ('a, 'b) owl_arr -> int = "complex_double_not_inf"
...
external owl_real_float_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_elt_equal"
external owl_real_double_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_elt_equal"
external owl_complex_float_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_elt_equal"
external owl_complex_double_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_elt_equal"
...
external owl_real_float_elt_not_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_elt_not_equal"
external owl_real_double_elt_not_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_elt_not_equal"
external owl_complex_float_elt_not_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_elt_not_equal"
external owl_complex_double_elt_not_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_elt_not_equal"
...
external owl_real_float_elt_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_elt_less"
external owl_real_double_elt_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_elt_less"
external owl_complex_float_elt_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_elt_less"
external owl_complex_double_elt_less : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_elt_less"
...
external owl_real_float_elt_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_elt_greater"
external owl_real_double_elt_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_elt_greater"
external owl_complex_float_elt_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_elt_greater"
external owl_complex_double_elt_greater : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_elt_greater"
...
external owl_real_float_elt_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_elt_less_equal"
external owl_real_double_elt_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_elt_less_equal"
external owl_complex_float_elt_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_elt_less_equal"
external owl_complex_double_elt_less_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_elt_less_equal"
...
external owl_real_float_elt_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_elt_greater_equal"
external owl_real_double_elt_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_elt_greater_equal"
external owl_complex_float_elt_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_elt_greater_equal"
external owl_complex_double_elt_greater_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_elt_greater_equal"
...
external owl_real_float_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_float_equal_scalar"
external owl_real_double_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_double_equal_scalar"
external owl_complex_float_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_float_equal_scalar"
external owl_complex_double_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_double_equal_scalar"
...
external owl_real_float_not_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_float_not_equal_scalar"
external owl_real_double_not_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_double_not_equal_scalar"
external owl_complex_float_not_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_float_not_equal_scalar"
external owl_complex_double_not_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_double_not_equal_scalar"
...
external owl_real_float_less_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_float_less_scalar"
external owl_real_double_less_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_double_less_scalar"
external owl_complex_float_less_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_float_less_scalar"
external owl_complex_double_less_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_double_less_scalar"
...
external owl_real_float_greater_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_float_greater_scalar"
external owl_real_double_greater_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_double_greater_scalar"
external owl_complex_float_greater_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_float_greater_scalar"
external owl_complex_double_greater_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_double_greater_scalar"
...
external owl_real_float_less_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_float_less_equal_scalar"
external owl_real_double_less_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_double_less_equal_scalar"
external owl_complex_float_less_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_float_less_equal_scalar"
external owl_complex_double_less_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_double_less_equal_scalar"
...
external owl_real_float_greater_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_float_greater_equal_scalar"
external owl_real_double_greater_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "real_double_greater_equal_scalar"
external owl_complex_float_greater_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_float_greater_equal_scalar"
external owl_complex_double_greater_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> int = "complex_double_greater_equal_scalar"
...
external owl_real_float_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_elt_equal_scalar"
external owl_real_double_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_elt_equal_scalar"
external owl_complex_float_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_elt_equal_scalar"
external owl_complex_double_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_elt_equal_scalar"
...
external owl_real_float_elt_not_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_elt_not_equal_scalar"
external owl_real_double_elt_not_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_elt_not_equal_scalar"
external owl_complex_float_elt_not_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_elt_not_equal_scalar"
external owl_complex_double_elt_not_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_elt_not_equal_scalar"
...
external owl_real_float_elt_less_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_elt_less_scalar"
external owl_real_double_elt_less_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_elt_less_scalar"
external owl_complex_float_elt_less_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_elt_less_scalar"
external owl_complex_double_elt_less_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_elt_less_scalar"
...
external owl_real_float_elt_greater_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_elt_greater_scalar"
external owl_real_double_elt_greater_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_elt_greater_scalar"
external owl_complex_float_elt_greater_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_elt_greater_scalar"
external owl_complex_double_elt_greater_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_elt_greater_scalar"
...
external owl_real_float_elt_less_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_elt_less_equal_scalar"
external owl_real_double_elt_less_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_elt_less_equal_scalar"
external owl_complex_float_elt_less_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_elt_less_equal_scalar"
external owl_complex_double_elt_less_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_elt_less_equal_scalar"
...
external owl_real_float_elt_greater_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_elt_greater_equal_scalar"
external owl_real_double_elt_greater_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_elt_greater_equal_scalar"
external owl_complex_float_elt_greater_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_elt_greater_equal_scalar"
external owl_complex_double_elt_greater_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_elt_greater_equal_scalar"
...
external owl_real_float_nnz : int -> ('a, 'b) owl_arr -> int = "real_float_nnz"
external owl_real_double_nnz : int -> ('a, 'b) owl_arr -> int = "real_double_nnz"
external owl_complex_float_nnz : int -> ('a, 'b) owl_arr -> int = "complex_float_nnz"
external owl_complex_double_nnz : int -> ('a, 'b) owl_arr -> int = "complex_double_nnz"
...
external owl_real_float_min_i : int -> ('a, 'b) owl_arr -> int = "real_float_min_i"
external owl_real_double_min_i : int -> ('a, 'b) owl_arr -> int = "real_double_min_i"
external owl_complex_float_min_i : int -> ('a, 'b) owl_arr -> int = "complex_float_min_i"
external owl_complex_double_min_i : int -> ('a, 'b) owl_arr -> int = "complex_double_min_i"
...
external owl_real_float_max_i : int -> ('a, 'b) owl_arr -> int = "real_float_max_i"
external owl_real_double_max_i : int -> ('a, 'b) owl_arr -> int = "real_double_max_i"
external owl_complex_float_max_i : int -> ('a, 'b) owl_arr -> int = "complex_float_max_i"
external owl_complex_double_max_i : int -> ('a, 'b) owl_arr -> int = "complex_double_max_i"
...
external owl_real_float_reci : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_reci"
external owl_real_double_reci : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_reci"
external owl_complex_float_reci : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_reci"
external owl_complex_double_reci : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_reci"
...
external owl_real_float_reci_tol : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_reci_tol"
external owl_real_double_reci_tol : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_reci_tol"
external owl_complex_float_reci_tol : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_reci_tol"
external owl_complex_double_reci_tol : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_reci_tol"
...
external owl_real_float_abs : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_abs"
external owl_real_double_abs : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_abs"
external owl_complex_float_abs : int -> (Complex.t, complex32_elt) owl_arr -> (float, float32_elt) owl_arr -> unit = "complex_float_abs"
external owl_complex_double_abs : int -> (Complex.t, complex64_elt) owl_arr -> (float, float64_elt) owl_arr -> unit = "complex_double_abs"
...
external owl_real_float_abs2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_abs2"
external owl_real_double_abs2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_abs2"
external owl_complex_float_abs2 : int -> (Complex.t, complex32_elt) owl_arr -> (float, float32_elt) owl_arr -> unit = "complex_float_abs2"
external owl_complex_double_abs2 : int -> (Complex.t, complex64_elt) owl_arr -> (float, float64_elt) owl_arr -> unit = "complex_double_abs2"
...
external owl_real_float_signum : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_signum"
external owl_real_double_signum : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_signum"
...
external owl_real_float_sqr : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_sqr"
external owl_real_double_sqr : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_sqr"
external owl_complex_float_sqr : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_sqr"
external owl_complex_double_sqr : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_sqr"
...
external owl_real_float_sqrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_sqrt"
external owl_real_double_sqrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_sqrt"
external owl_complex_float_sqrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_sqrt"
external owl_complex_double_sqrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_sqrt"
...
external owl_real_float_cbrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_cbrt"
external owl_real_double_cbrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_cbrt"
external owl_complex_float_cbrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_cbrt"
external owl_complex_double_cbrt : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_cbrt"
...
external owl_real_float_exp : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_exp"
external owl_real_double_exp : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_exp"
external owl_complex_float_exp : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_exp"
external owl_complex_double_exp : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_exp"
...
external owl_real_float_exp2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_exp2"
external owl_real_double_exp2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_exp2"
external owl_complex_float_exp2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_exp2"
external owl_complex_double_exp2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_exp2"
...
external owl_real_float_exp10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_exp10"
external owl_real_double_exp10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_exp10"
external owl_complex_float_exp10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_exp10"
external owl_complex_double_exp10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_exp10"
...
external owl_real_float_expm1 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_expm1"
external owl_real_double_expm1 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_expm1"
external owl_complex_float_expm1 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_expm1"
external owl_complex_double_expm1 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_expm1"
...
external owl_real_float_log : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_log"
external owl_real_double_log : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_log"
external owl_complex_float_log : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_log"
external owl_complex_double_log : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_log"
...
external owl_real_float_log10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_log10"
external owl_real_double_log10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_log10"
external owl_complex_float_log10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_log10"
external owl_complex_double_log10 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_log10"
...
external owl_real_float_log2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_log2"
external owl_real_double_log2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_log2"
external owl_complex_float_log2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_log2"
external owl_complex_double_log2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_log2"
...
external owl_real_float_log1p : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_log1p"
external owl_real_double_log1p : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_log1p"
external owl_complex_float_log1p : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_log1p"
external owl_complex_double_log1p : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_log1p"
...
external owl_real_float_sin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_sin"
external owl_real_double_sin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_sin"
external owl_complex_float_sin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_sin"
external owl_complex_double_sin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_sin"
...
external owl_real_float_cos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_cos"
external owl_real_double_cos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_cos"
external owl_complex_float_cos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_cos"
external owl_complex_double_cos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_cos"
...
external owl_real_float_tan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_tan"
external owl_real_double_tan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_tan"
external owl_complex_float_tan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_tan"
external owl_complex_double_tan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_tan"
...
external owl_real_float_asin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_asin"
external owl_real_double_asin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_asin"
external owl_complex_float_asin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_asin"
external owl_complex_double_asin : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_asin"
...
external owl_real_float_acos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_acos"
external owl_real_double_acos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_acos"
external owl_complex_float_acos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_acos"
external owl_complex_double_acos : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_acos"
...
external owl_real_float_atan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_atan"
external owl_real_double_atan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_atan"
external owl_complex_float_atan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_atan"
external owl_complex_double_atan : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_atan"
...
external owl_real_float_sinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_sinh"
external owl_real_double_sinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_sinh"
external owl_complex_float_sinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_sinh"
external owl_complex_double_sinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_sinh"
...
external owl_real_float_cosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_cosh"
external owl_real_double_cosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_cosh"
external owl_complex_float_cosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_cosh"
external owl_complex_double_cosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_cosh"
...
external owl_real_float_tanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_tanh"
external owl_real_double_tanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_tanh"
external owl_complex_float_tanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_tanh"
external owl_complex_double_tanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_tanh"
...
external owl_real_float_asinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_asinh"
external owl_real_double_asinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_asinh"
external owl_complex_float_asinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_asinh"
external owl_complex_double_asinh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_asinh"
...
external owl_real_float_acosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_acosh"
external owl_real_double_acosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_acosh"
external owl_complex_float_acosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_acosh"
external owl_complex_double_acosh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_acosh"
...
external owl_real_float_atanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_atanh"
external owl_real_double_atanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_atanh"
external owl_complex_float_atanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_atanh"
external owl_complex_double_atanh : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_atanh"
...
external owl_real_float_floor : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_floor"
external owl_real_double_floor : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_floor"
external owl_complex_float_floor : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_floor"
external owl_complex_double_floor : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_floor"
...
external owl_real_float_ceil : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_ceil"
external owl_real_double_ceil : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_ceil"
external owl_complex_float_ceil : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_ceil"
external owl_complex_double_ceil : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_ceil"
...
external owl_real_float_round : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_round"
external owl_real_double_round : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_round"
external owl_complex_float_round : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_round"
external owl_complex_double_round : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_round"
...
external owl_real_float_trunc : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_trunc"
external owl_real_double_trunc : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_trunc"
external owl_complex_float_trunc : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_trunc"
external owl_complex_double_trunc : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_trunc"
...
external owl_real_float_fix : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_fix"
external owl_real_double_fix : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_fix"
external owl_complex_float_fix : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_fix"
external owl_complex_double_fix : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_fix"
...
external owl_complex_float_angle : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_angle"
external owl_complex_double_angle : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_angle"
...
external owl_complex_float_proj : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_proj"
external owl_complex_double_proj : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_proj"
...
external owl_real_float_erf : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_erf"
external owl_real_double_erf : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_erf"
...
external owl_real_float_erfc : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_erfc"
external owl_real_double_erfc : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_erfc"
...
external owl_real_float_logistic : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_logistic"
external owl_real_double_logistic : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_logistic"
...
external owl_real_float_sigmoid : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_sigmoid"
external owl_real_double_sigmoid : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_sigmoid"
...
external owl_real_float_elu : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_elu"
external owl_real_double_elu : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_elu"
...
external owl_real_float_relu : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_relu"
external owl_real_double_relu : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_relu"
...
external owl_real_float_leaky_relu : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_leaky_relu"
external owl_real_double_leaky_relu : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_leaky_relu"
...
external owl_real_float_softplus : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_softplus"
external owl_real_double_softplus : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_softplus"
...
external owl_real_float_softsign : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_softsign"
external owl_real_double_softsign : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_softsign"
...
external owl_real_float_l1norm : int -> (float, 'a) owl_arr -> float = "real_float_l1norm"
external owl_real_double_l1norm : int -> (float, 'a) owl_arr -> float = "real_double_l1norm"
external owl_complex_float_l1norm : int -> (Complex.t, 'a) owl_arr -> float = "complex_float_l1norm"
external owl_complex_double_l1norm : int -> (Complex.t, 'a) owl_arr -> float = "complex_double_l1norm"
...
external owl_real_float_l2norm_sqr : int -> (float, 'a) owl_arr -> float = "real_float_l2norm_sqr"
external owl_real_double_l2norm_sqr : int -> (float, 'a) owl_arr -> float = "real_double_l2norm_sqr"
external owl_complex_float_l2norm_sqr : int -> (Complex.t, 'a) owl_arr -> float = "complex_float_l2norm_sqr"
external owl_complex_double_l2norm_sqr : int -> (Complex.t, 'a) owl_arr -> float = "complex_double_l2norm_sqr"
...
external owl_real_float_sum : int -> (float, 'a) owl_arr -> float = "real_float_sum"
external owl_real_double_sum : int -> (float, 'a) owl_arr -> float = "real_double_sum"
external owl_complex_float_sum : int -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_float_sum"
external owl_complex_double_sum : int -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_double_sum"
...
external owl_real_float_prod : int -> (float, 'a) owl_arr -> float = "real_float_prod"
external owl_real_double_prod : int -> (float, 'a) owl_arr -> float = "real_double_prod"
external owl_complex_float_prod : int -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_float_prod"
external owl_complex_double_prod : int -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_double_prod"
...
external owl_real_float_ssqr : int -> float -> (float, 'a) owl_arr -> float = "real_float_ssqr"
external owl_real_double_ssqr : int -> float -> (float, 'a) owl_arr -> float = "real_double_ssqr"
external owl_complex_float_ssqr : int -> Complex.t -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_float_ssqr"
external owl_complex_double_ssqr : int -> Complex.t -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_double_ssqr"
...
external owl_real_float_ssqr_diff : int -> (float, 'a) owl_arr -> (float, 'a) owl_arr -> float = "real_float_ssqr_diff"
external owl_real_double_ssqr_diff : int -> (float, 'a) owl_arr -> (float, 'a) owl_arr -> float = "real_double_ssqr_diff"
external owl_complex_float_ssqr_diff : int -> (Complex.t, 'a) owl_arr -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_float_ssqr_diff"
external owl_complex_double_ssqr_diff : int -> (Complex.t, 'a) owl_arr -> (Complex.t, 'a) owl_arr -> Complex.t = "complex_double_ssqr_diff"
...
external owl_real_float_log_sum_exp : int -> (float, 'a) owl_arr -> float = "real_float_log_sum_exp"
external owl_real_double_log_sum_exp : int -> (float, 'a) owl_arr -> float = "real_double_log_sum_exp"
...
external owl_complex_double_mul : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_mul"

let _owl_mul : type a b. (a, b) kind -> (a, b) owl_arr_op03 = fun k l x y z ->
  match k with
  | Float32   -> owl_real_float_mul l x y z
  | Float64   -> owl_real_double_mul l x y z
  | Complex32 -> owl_complex_float_mul l x y z
  | Complex64 -> owl_complex_double_mul l x y z
  | _         -> failwith "_owl_mul: unsupported operation"

external owl_real_float_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_div"
external owl_real_double_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_div"
external owl_complex_float_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_div"
external owl_complex_double_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_div"

let _owl_div : type a b. (a, b) kind -> (a, b) owl_arr_op03 = fun k l x y z ->
  match k with
  | Float32   -> owl_real_float_div l x y z
  | Float64   -> owl_real_double_div l x y z
  | Complex32 -> owl_complex_float_div l x y z
  | Complex64 -> owl_complex_double_div l x y z
  | _         -> failwith "_owl_div: unsupported operation"

external owl_real_float_add_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_add_scalar"
external owl_real_double_add_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_add_scalar"
external owl_complex_float_add_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_add_scalar"
external owl_complex_double_add_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_add_scalar"

let _owl_add_scalar : type a b. (a, b) kind -> (a, b) owl_arr_op11 = function
  | Float32   -> owl_real_float_add_scalar
  | Float64   -> owl_real_double_add_scalar
  | Complex32 -> owl_complex_float_add_scalar
  | Complex64 -> owl_complex_double_add_scalar
  | _         -> failwith "_owl_add_scalar: unsupported operation"

external owl_real_float_scalar_sub : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_scalar_sub"
external owl_real_double_scalar_sub : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_scalar_sub"
external owl_complex_float_scalar_sub : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_scalar_sub"
external owl_complex_double_scalar_sub : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_scalar_sub"

let _owl_scalar_sub : type a b. (a, b) kind -> (a, b) owl_arr_op11 = function
  | Float32   -> owl_real_float_scalar_sub
  | Float64   -> owl_real_double_scalar_sub
  | Complex32 -> owl_complex_float_scalar_sub
  | Complex64 -> owl_complex_double_scalar_sub
  | _         -> failwith "_owl_scalar_sub: unsupported operation"

external owl_real_float_scalar_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_scalar_div"
external owl_real_double_scalar_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_scalar_div"
external owl_complex_float_scalar_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_scalar_div"
external owl_complex_double_scalar_div : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_scalar_div"

let _owl_scalar_div : type a b. (a, b) kind -> (a, b) owl_arr_op11 = function
  | Float32   -> owl_real_float_scalar_div
  | Float64   -> owl_real_double_scalar_div
  | Complex32 -> owl_complex_float_scalar_div
  | Complex64 -> owl_complex_double_scalar_div
  | _         -> failwith "_owl_scalar_div: unsupported operation"

external owl_real_float_scalar_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_scalar_pow"
external owl_real_double_scalar_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_scalar_pow"
external owl_complex_float_scalar_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_scalar_pow"
external owl_complex_double_scalar_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_scalar_pow"

let _owl_scalar_pow : type a b. (a, b) kind -> (a, b) owl_arr_op11 = function
  | Float32   -> owl_real_float_scalar_pow
  | Float64   -> owl_real_double_scalar_pow
  | Complex32 -> owl_complex_float_scalar_pow
  | Complex64 -> owl_complex_double_scalar_pow
  | _         -> failwith "_owl_scalar_pow: unsupported operation"

external owl_real_float_pow_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_pow_scalar"
external owl_real_double_pow_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_pow_scalar"
external owl_complex_float_pow_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_pow_scalar"
external owl_complex_double_pow_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_pow_scalar"

let _owl_pow_scalar : type a b. (a, b) kind -> (a, b) owl_arr_op11 = function
  | Float32   -> owl_real_float_pow_scalar
  | Float64   -> owl_real_double_pow_scalar
  | Complex32 -> owl_complex_float_pow_scalar
  | Complex64 -> owl_complex_double_pow_scalar
  | _         -> failwith "_owl_pow_scalar: unsupported operation"

external owl_real_float_scalar_atan2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_scalar_atan2"
external owl_real_double_scalar_atan2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_scalar_atan2"

let _owl_scalar_atan2 : type a b. (a, b) kind -> (a, b) owl_arr_op11 = function
  | Float32   -> owl_real_float_scalar_atan2
  | Float64   -> owl_real_double_scalar_atan2
  | _         -> failwith "_owl_scalar_atan2: unsupported operation"

external owl_real_float_atan2_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_atan2_scalar"
external owl_real_double_atan2_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_atan2_scalar"

let _owl_atan2_scalar : type a b. (a, b) kind -> (a, b) owl_arr_op11 = function
  | Float32   -> owl_real_float_atan2_scalar
  | Float64   -> owl_real_double_atan2_scalar
  | _         -> failwith "_owl_atan2_scalar: unsupported operation"

external owl_real_float_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_pow"
external owl_real_double_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_pow"
external owl_complex_float_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_pow"
external owl_complex_double_pow : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_pow"
...
external owl_real_float_atan2 : int -> ('a, 'b) owl_arr -> (float, 'c) owl_arr -> (float, 'c) owl_arr -> unit = "real_float_atan2"
external owl_real_double_atan2 : int -> ('a, 'b) owl_arr -> (float, 'c) owl_arr -> (float, 'c) owl_arr -> unit = "real_double_atan2"
...
external owl_real_float_hypot : int -> ('a, 'b) owl_arr -> (float, 'c) owl_arr -> (float, 'c) owl_arr -> unit = "real_float_hypot"
external owl_real_double_hypot : int -> ('a, 'b) owl_arr -> (float, 'c) owl_arr -> (float, 'c) owl_arr -> unit = "real_double_hypot"
...
external owl_real_float_min2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_min2"
external owl_real_double_min2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_min2"
external owl_complex_float_min2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_min2"
external owl_complex_double_min2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_min2"
...
external owl_real_float_max2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_max2"
external owl_real_double_max2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_max2"
external owl_complex_float_max2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_max2"
external owl_complex_double_max2 : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_max2"
...
external owl_real_float_fmod : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_fmod"
external owl_real_double_fmod : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_fmod"
...
external owl_real_float_fmod_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_fmod_scalar"
external owl_real_double_fmod_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_fmod_scalar"
...
external owl_real_float_scalar_fmod : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_scalar_fmod"
external owl_real_double_scalar_fmod : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_scalar_fmod"
...
external owl_real_float_linspace : int -> float -> float -> (float, 'a) owl_arr -> unit = "real_float_linspace"
external owl_real_double_linspace : int -> float -> float -> (float, 'a) owl_arr -> unit = "real_double_linspace"
external owl_complex_float_linspace : int -> Complex.t -> Complex.t -> (Complex.t, 'a) owl_arr -> unit = "complex_float_linspace"
external owl_complex_double_linspace : int -> Complex.t -> Complex.t -> (Complex.t, 'a) owl_arr -> unit = "complex_double_linspace"
...
external owl_real_float_logspace : int -> float -> float -> float -> (float, 'a) owl_arr -> unit = "real_float_logspace"
external owl_real_double_logspace : int -> float -> float -> float -> (float, 'a) owl_arr -> unit = "real_double_logspace"
external owl_complex_float_logspace : int -> float -> Complex.t -> Complex.t -> (Complex.t, 'a) owl_arr -> unit = "complex_float_logspace"
external owl_complex_double_logspace : int -> float -> Complex.t -> Complex.t -> (Complex.t, 'a) owl_arr -> unit = "complex_double_logspace"
...
external owl_real_float_bernoulli : int -> ('a, 'b) owl_arr -> float -> int -> unit = "real_float_bernoulli"
external owl_real_double_bernoulli : int -> ('a, 'b) owl_arr -> float -> int -> unit = "real_double_bernoulli"
external owl_complex_float_bernoulli : int -> ('a, 'b) owl_arr -> float -> int -> unit = "complex_float_bernoulli"
external owl_complex_double_bernoulli : int -> ('a, 'b) owl_arr -> float -> int -> unit = "complex_double_bernoulli"
...
external owl_real_float_sequential : int -> ('a, 'b) owl_arr -> 'a -> 'a -> unit = "real_float_sequential"
external owl_real_double_sequential : int -> ('a, 'b) owl_arr -> 'a -> 'a -> unit = "real_double_sequential"
external owl_complex_float_sequential : int -> ('a, 'b) owl_arr -> 'a -> 'a -> unit = "complex_float_sequential"
external owl_complex_double_sequential : int -> ('a, 'b) owl_arr -> 'a -> 'a -> unit = "complex_double_sequential"
...
external owl_real_float_modf : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_modf"
external owl_real_double_modf : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_modf"
external owl_complex_float_modf : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_modf"
external owl_complex_double_modf : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_modf"
...
external owl_real_float_approx_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> float -> int = "real_float_approx_equal"
external owl_real_double_approx_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> float -> int = "real_double_approx_equal"
external owl_complex_float_approx_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> float -> int = "complex_float_approx_equal"
external owl_complex_double_approx_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> float -> int = "complex_double_approx_equal"
...
external owl_real_float_approx_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> float -> int = "real_float_approx_equal_scalar"
external owl_real_double_approx_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> float -> int = "real_double_approx_equal_scalar"
external owl_complex_float_approx_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> float -> int = "complex_float_approx_equal_scalar"
external owl_complex_double_approx_equal_scalar : int -> ('a, 'b) owl_arr -> 'a -> float -> int = "complex_double_approx_equal_scalar"
...
external owl_real_float_approx_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_float_approx_elt_equal"
external owl_real_double_approx_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "real_double_approx_elt_equal"
external owl_complex_float_approx_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_float_approx_elt_equal"
external owl_complex_double_approx_elt_equal : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit = "complex_double_approx_elt_equal"
...
external owl_real_float_approx_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_float_approx_elt_equal_scalar"
external owl_real_double_approx_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "real_double_approx_elt_equal_scalar"
external owl_complex_float_approx_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_float_approx_elt_equal_scalar"
external owl_complex_double_approx_elt_equal_scalar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> 'a -> unit = "complex_double_approx_elt_equal_scalar"
...
external owl_real_float_to_complex : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('c, 'd) owl_arr -> unit = "real_float_to_complex"
external owl_real_double_to_complex : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('c, 'd) owl_arr -> unit = "real_double_to_complex"
external owl_complex_float_to_complex : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('c, 'd) owl_arr -> unit = "complex_float_to_complex"
external owl_complex_double_to_complex : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('c, 'd) owl_arr -> unit = "complex_double_to_complex"
...
external owl_real_float_polar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('c, 'd) owl_arr -> unit = "real_float_polar"
external owl_real_double_polar : int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('c, 'd) owl_arr -> unit = "real_double_polar"
...
external owl_real_float_clip_by_value : int -> float -> float -> (float, 'a) owl_arr -> unit = "real_float_clip_by_value"
external owl_real_double_clip_by_value : int -> float -> float -> (float, 'a) owl_arr -> unit = "real_double_clip_by_value"
external owl_complex_float_clip_by_value : int -> Complex.t -> Complex.t -> (Complex.t, 'a) owl_arr -> unit = "complex_float_clip_by_value"
external owl_complex_double_clip_by_value : int -> Complex.t -> Complex.t -> (Complex.t, 'a) owl_arr -> unit = "complex_double_clip_by_value"
...
external owl_real_float_broadcast_max2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_float_broadcast_max2" "real_float_broadcast_max2_impl"
external owl_real_double_broadcast_max2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_double_broadcast_max2" "real_double_broadcast_max2_impl"
external owl_complex_float_broadcast_max2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "complex_float_broadcast_max2" "complex_double_broadcast_max2_impl"
external owl_complex_double_broadcast_max2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "complex_float_broadcast_max2" "complex_double_broadcast_max2_impl"

let _owl_broadcast_max2 : type a b. (a, b) kind -> (a, b) owl_arr_op17 = function
  | Float32   -> owl_real_float_broadcast_max2
  | Float64   -> owl_real_double_broadcast_max2
  | Complex32 -> owl_complex_float_broadcast_max2
  | Complex64 -> owl_complex_double_broadcast_max2
  | _         -> failwith "_owl_broadcast_max2: unsupported operation"

external owl_real_float_broadcast_min2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_float_broadcast_min2" "real_float_broadcast_min2_impl"
external owl_real_double_broadcast_min2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_double_broadcast_min2" "real_double_broadcast_min2_impl"
external owl_complex_float_broadcast_min2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "complex_float_broadcast_min2" "complex_double_broadcast_min2_impl"
external owl_complex_double_broadcast_min2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "complex_float_broadcast_min2" "complex_double_broadcast_min2_impl"

let _owl_broadcast_min2 : type a b. (a, b) kind -> (a, b) owl_arr_op17 = function
  | Float32   -> owl_real_float_broadcast_min2
  | Float64   -> owl_real_double_broadcast_min2
  | Complex32 -> owl_complex_float_broadcast_min2
  | Complex64 -> owl_complex_double_broadcast_min2
  | _         -> failwith "_owl_broadcast_min2: unsupported operation"

external owl_real_float_broadcast_pow : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_float_broadcast_pow" "real_float_broadcast_pow_impl"
external owl_real_double_broadcast_pow : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_double_broadcast_pow" "real_double_broadcast_pow_impl"
external owl_complex_float_broadcast_pow : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "complex_float_broadcast_pow" "complex_double_broadcast_pow_impl"
external owl_complex_double_broadcast_pow : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "complex_float_broadcast_pow" "complex_double_broadcast_pow_impl"

let _owl_broadcast_pow : type a b. (a, b) kind -> (a, b) owl_arr_op17 = function
  | Float32   -> owl_real_float_broadcast_pow
  | Float64   -> owl_real_double_broadcast_pow
  | Complex32 -> owl_complex_float_broadcast_pow
  | Complex64 -> owl_complex_double_broadcast_pow
  | _         -> failwith "_owl_broadcast_pow: unsupported operation"

external owl_real_float_broadcast_atan2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_float_broadcast_atan2" "real_float_broadcast_atan2_impl"
external owl_real_double_broadcast_atan2 : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_double_broadcast_atan2" "real_double_broadcast_atan2_impl"

let _owl_broadcast_atan2 : type a b. (a, b) kind -> (a, b) owl_arr_op17 = function
  | Float32   -> owl_real_float_broadcast_atan2
  | Float64   -> owl_real_double_broadcast_atan2
  | _         -> failwith "_owl_broadcast_atan2: unsupported operation"

external owl_real_float_broadcast_hypot : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_float_broadcast_hypot" "real_float_broadcast_hypot_impl"
external owl_real_double_broadcast_hypot : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_double_broadcast_hypot" "real_double_broadcast_hypot_impl"

let _owl_broadcast_hypot : type a b. (a, b) kind -> (a, b) owl_arr_op17 = function
  | Float32   -> owl_real_float_broadcast_hypot
  | Float64   -> owl_real_double_broadcast_hypot
  | _         -> failwith "_owl_broadcast_hypot: unsupported operation"

external owl_real_float_broadcast_fmod : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_float_broadcast_fmod" "real_float_broadcast_fmod_impl"
external owl_real_double_broadcast_fmod : ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> ('a, 'b) owl_arr -> (int64, int64_elt) owl_arr -> unit = "real_double_broadcast_fmod" "real_double_broadcast_fmod_impl"

let _owl_broadcast_fmod : type a b. (a, b) kind -> (a, b) owl_arr_op17 = function
  | Float32   -> owl_real_float_broadcast_fmod
  | Float64   -> owl_real_double_broadcast_fmod
