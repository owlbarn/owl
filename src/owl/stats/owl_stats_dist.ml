...
external exponential_logpdf
  :  float
  -> lambda:float
  -> float
  = "owl_stub_exponential_logpdf"

external exponential_cdf : float -> lambda:float -> float = "owl_stub_exponential_cdf"

external exponential_logcdf
  :  float
  -> lambda:float
  -> float
  = "owl_stub_exponential_logcdf"
...
external exponpow_logpdf
  :  float
  -> a:float
  -> b:float
  -> float
  = "owl_stub_exponpow_logpdf"

external exponpow_cdf : float -> a:float -> b:float -> float = "owl_stub_exponpow_cdf"

external exponpow_logcdf
  :  float
  -> a:float
  -> b:float
  -> float
  = "owl_stub_exponpow_logcdf"
...
external gaussian_pdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_gaussian_pdf"

external gaussian_logpdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_gaussian_logpdf"

external gaussian_cdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_gaussian_cdf"

external gaussian_logcdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_gaussian_logcdf"

external gaussian_ppf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_gaussian_ppf"

external gaussian_sf : float -> mu:float -> sigma:float -> float = "owl_stub_gaussian_sf"

external gaussian_logsf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_gaussian_logsf"

external gaussian_isf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_gaussian_isf"
...
external gamma_logpdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_gamma_logpdf"

external gamma_cdf : float -> shape:float -> scale:float -> float = "owl_stub_gamma_cdf"

external gamma_logcdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_gamma_logcdf"
...
external gamma_logsf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_gamma_logsf"
...
external cauchy_logpdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_cauchy_logpdf"

external cauchy_cdf : float -> loc:float -> scale:float -> float = "owl_stub_cauchy_cdf"

external cauchy_logcdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_cauchy_logcdf"
...
external cauchy_logsf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_cauchy_logsf"
...
external vonmises_pdf
  :  float
  -> mu:float
  -> kappa:float
  -> float
  = "owl_stub_vonmises_pdf"

external vonmises_logpdf
  :  float
  -> mu:float
  -> kappa:float
  -> float
  = "owl_stub_vonmises_logpdf"

external vonmises_cdf
  :  float
  -> mu:float
  -> kappa:float
  -> float
  = "owl_stub_vonmises_cdf"

external vonmises_logcdf
  :  float
  -> mu:float
  -> kappa:float
  -> float
  = "owl_stub_vonmises_logcdf"
...
external vonmises_logsf
  :  float
  -> mu:float
  -> kappa:float
  -> float
  = "owl_stub_vonmises_logsf"
...
external lomax_logpdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_lomax_logpdf"

external lomax_cdf : float -> shape:float -> scale:float -> float = "owl_stub_lomax_cdf"

external lomax_logcdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_lomax_logcdf"
...
external lomax_logsf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_lomax_logsf"
...
external weibull_pdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_weibull_pdf"

external weibull_logpdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_weibull_logpdf"

external weibull_cdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_weibull_cdf"

external weibull_logcdf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_weibull_logcdf"

external weibull_ppf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_weibull_ppf"

external weibull_sf : float -> shape:float -> scale:float -> float = "owl_stub_weibull_sf"

external weibull_logsf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_weibull_logsf"

external weibull_isf
  :  float
  -> shape:float
  -> scale:float
  -> float
  = "owl_stub_weibull_isf"
...
external laplace_logpdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_laplace_logpdf"

external laplace_cdf : float -> loc:float -> scale:float -> float = "owl_stub_laplace_cdf"

external laplace_logcdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_laplace_logcdf"
...
external laplace_logsf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_laplace_logsf"
...
external logistic_pdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_logistic_pdf"

external logistic_logpdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_logistic_logpdf"

external logistic_cdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_logistic_cdf"

external logistic_logcdf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_logistic_logcdf"

external logistic_ppf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_logistic_ppf"

external logistic_sf : float -> loc:float -> scale:float -> float = "owl_stub_logistic_sf"

external logistic_logsf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_logistic_logsf"

external logistic_isf
  :  float
  -> loc:float
  -> scale:float
  -> float
  = "owl_stub_logistic_isf"

external lognormal_rvs : mu:float -> sigma:float -> float = "owl_stub_lognormal_rvs"

external lognormal_pdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_pdf"

external lognormal_logpdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_logpdf"

external lognormal_cdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_cdf"

external lognormal_logcdf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_logcdf"

external lognormal_ppf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_ppf"

external lognormal_sf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_sf"

external lognormal_logsf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_logsf"

external lognormal_isf
  :  float
  -> mu:float
  -> sigma:float
  -> float
  = "owl_stub_lognormal_isf"
...
external hypergeometric_rvs
  :  good:int
  -> bad:int
  -> sample:int
  -> int
  = "owl_stub_hypergeometric_rvs"

external hypergeometric_pdf
  :  int
  -> good:int
  -> bad:int
  -> sample:int
  -> float
  = "owl_stub_hypergeometric_pdf"

external hypergeometric_logpdf
  :  int
  -> good:int
  -> bad:int
  -> sample:int
  -> float
  = "owl_stub_hypergeometric_logpdf"
...
external _multinomial_rvs
  :  k:int
  -> n:int
  -> p:(float, float64_elt) owl_arr
  -> (int32, int32_elt) owl_arr
  -> unit
  = "owl_stub_multinomial_rvs"
...
external _multinomial_pdf
  :  k:int
  -> p:(float, float64_elt) owl_arr
  -> (int32, int32_elt) owl_arr
  -> float
  = "owl_stub_multinomial_pdf"
...
external _multinomial_logpdf
  :  k:int
  -> p:(float, float64_elt) owl_arr
  -> (int32, int32_elt) owl_arr
  -> float
  = "owl_stub_multinomial_logpdf"
...
external _dirichlet_rvs
  :  k:int
  -> alpha:(float, float64_elt) owl_arr
  -> theta:(float, float64_elt) owl_arr
  -> unit
  = "owl_stub_dirchlet_rvs"
...
external _dirichlet_pdf
  :  k:int
  -> alpha:(float, float64_elt) owl_arr
  -> theta:(float, float64_elt) owl_arr
  -> float
  = "owl_stub_dirchlet_pdf"

let dirichlet_pdf x ~alpha =
  if Owl_base_maths.is_simplex x = false then raise Owl_exception.NOT_SIMPLEX;
  let k = Array.length alpha in
  let _a = Genarray.create float64 c_layout [| k |] in
...
external _dirichlet_logpdf
  :  k:int
  -> alpha:(float, float64_elt) owl_arr
  -> theta:(float, float64_elt) owl_arr
  -> float
  = "owl_stub_dirchlet_logpdf"
