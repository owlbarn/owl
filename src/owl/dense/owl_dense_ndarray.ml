...
module Generic = struct
  ...
  let discrete_lyapunov ?(solver = `default) a q =
    Owl_linalg_generic.discrete_lyapunov ~solver a q


  let linsolve ?(trans = false) ?(typ = `n) a b =
    Owl_linalg_generic.linsolve ~trans ~typ a b
...
module S = struct
  ...
  let discrete_lyapunov ?(solver = `default) a q =
    Owl_linalg_s.discrete_lyapunov ~solver a q
...
module D = struct
  ...
  let discrete_lyapunov ?(solver = `default) a q =
    Owl_linalg_d.discrete_lyapunov ~solver a q
...
module C = struct
  ...
  let discrete_lyapunov ?(solver = `default) a q =
    Owl_linalg_c.discrete_lyapunov ~solver a q
...
module Z = struct
  ...
  let discrete_lyapunov ?(solver = `default) a q =
    Owl_linalg_z.discrete_lyapunov ~solver a q
