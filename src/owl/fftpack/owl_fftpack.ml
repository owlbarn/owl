...
let _owl_rfftf
    : type a b c d.
      (a, b) kind -> (c, d) kind -> (a, b) owl_arr -> (c, d) owl_arr -> int -> unit
  =
...
let _owl_cfftf : type a b. (a, b) kind -> (a, b) owl_arr -> (a, b) owl_arr -> int -> unit
  = function
...
let _owl_cfftb : type a b. (a, b) kind -> (a, b) owl_arr -> (a, b) owl_arr -> int -> unit
  = function
