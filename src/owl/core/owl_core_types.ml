...
type ('a, 'b) owl_arr_op03 =
  int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit
...
type ('a, 'b, 'c, 'd) owl_arr_op19 =
  int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('c, 'd) owl_arr -> unit

type ('a, 'b) owl_arr_op20 =
  int
  -> int
  -> int
  -> ('a, 'b) owl_arr
...
type ('a, 'b) owl_arr_op21 =
  int -> int -> int -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit

type ('a, 'b) owl_arr_op22 =
  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> int
...
type ('a, 'b) owl_arr_op33 =
  int -> 'a -> 'a -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> unit

type ('a, 'b) owl_arr_op34 =
  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> int
