...
external owl_float32_ndarray_contract_one : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> int32 -> unit = "stub_float32_ndarray_contract_one"
external owl_float64_ndarray_contract_one : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> int32 -> unit = "stub_float64_ndarray_contract_one"
external owl_complex32_ndarray_contract_one : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> int32 -> unit = "stub_complex32_ndarray_contract_one"
external owl_complex64_ndarray_contract_one : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> int32 -> unit = "stub_complex64_ndarray_contract_one"

let _ndarray_contract_one
  : type a b. (a, b) kind -> (a, b) owl_arr -> (a, b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> int32 -> unit
  = function
...
external owl_float32_ndarray_contract_two : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int64, int64_elt) owl_arr -> int32 -> unit = "stub_float32_ndarray_contract_two_byte" "stub_float32_ndarray_contract_two"
external owl_float64_ndarray_contract_two : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int64, int64_elt) owl_arr -> int32 -> unit = "stub_float64_ndarray_contract_two_byte" "stub_float64_ndarray_contract_two"
external owl_complex32_ndarray_contract_two : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int64, int64_elt) owl_arr -> int32 -> unit = "stub_complex32_ndarray_contract_two_byte" "stub_complex32_ndarray_contract_two"
external owl_complex64_ndarray_contract_two : ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> ('a, 'b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int64, int64_elt) owl_arr -> int32 -> unit = "stub_complex64_ndarray_contract_two_byte" "stub_complex64_ndarray_contract_two"

let _ndarray_contract_two
  : type a b. (a, b) kind -> (a, b) owl_arr -> (a, b) owl_arr -> (a, b) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int32, int32_elt) owl_arr -> (int64, int64_elt) owl_arr -> int32 -> unit
  = function
