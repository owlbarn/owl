...
external owl_float32_ndarray_get_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float32_ndarray_get_fancy"

external owl_float64_ndarray_get_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float64_ndarray_get_fancy"

external owl_complex32_ndarray_get_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex32_ndarray_get_fancy"

external owl_complex64_ndarray_get_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex64_ndarray_get_fancy"
...
external owl_float32_ndarray_set_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float32_ndarray_set_fancy"

external owl_float64_ndarray_set_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float64_ndarray_set_fancy"

external owl_complex32_ndarray_set_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex32_ndarray_set_fancy"

external owl_complex64_ndarray_set_fancy
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex64_ndarray_set_fancy"
  ...
  Array.iteri
    (fun i a ->
      ...
      | L_ x ->
        ...
        Array.iteri (fun o y -> Genarray.set index [| !k + o |] (Int64.of_int y)) x;
        k := !k + l
      | R_ x ->
