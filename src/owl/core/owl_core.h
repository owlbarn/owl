...
extern void c_float32_ndarray_contract_one (struct slice_pair *sp);

extern void c_float64_ndarray_contract_one (struct slice_pair *sp);

extern void c_complex32_ndarray_contract_one (struct slice_pair *sp);

extern void c_complex64_ndarray_contract_one (struct slice_pair *sp);
