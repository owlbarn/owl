...
CAMLprim value FUN_NATIVE (spatial_transpose_backward_kernel) (
  value vInput_ptr, value vKernel_ptr, value vOutput_ptr,
  value vBatches, value vInput_cols, value vInput_rows, value vIn_channel,
  value vKernel_cols, value vKernel_rows,
  value vOutput_cols, value vOutput_rows, value vOut_channel,
...
CAMLprim value FUN_BYTE (spatial_transpose_backward_kernel) (value * argv, int argn) {
  return FUN_NATIVE (spatial_transpose_backward_kernel) (
    argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7],
    argv[8], argv[9], argv[10], argv[11], argv[12], argv[13], argv[14], argv[15]
  );
}
...
CAMLprim value FUN_NATIVE (spatial_transpose_backward_input) (
  value vInput_ptr, value vKernel_ptr, value vOutput_ptr,
  value vBatches, value vInput_cols, value vInput_rows, value vIn_channel,
  value vKernel_cols, value vKernel_rows,
  value vOutput_cols, value vOutput_rows, value vOut_channel,
...
CAMLprim value FUN_BYTE (spatial_transpose_backward_input) (value * argv, int argn) {
  return FUN_NATIVE (spatial_transpose_backward_input) (
    argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7],
    argv[8], argv[9], argv[10], argv[11], argv[12], argv[13], argv[14], argv[15]
  );
}
