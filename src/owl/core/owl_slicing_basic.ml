...
external owl_float32_ndarray_get_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float32_ndarray_get_slice"

external owl_float64_ndarray_get_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float64_ndarray_get_slice"

external owl_complex32_ndarray_get_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex32_ndarray_get_slice"

external owl_complex64_ndarray_get_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex64_ndarray_get_slice"

let _ndarray_get_slice
    : type a b c.
      (a, b) kind -> (a, b) owl_arr -> (a, b) owl_arr -> (int64, c) owl_arr -> unit
  = function
...
external owl_float32_ndarray_set_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float32_ndarray_set_slice"

external owl_float64_ndarray_set_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_float64_ndarray_set_slice"

external owl_complex32_ndarray_set_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex32_ndarray_set_slice"

external owl_complex64_ndarray_set_slice
  :  ('a, 'b) owl_arr
  -> ('a, 'b) owl_arr
  -> (int64, 'c) owl_arr
  -> unit
  = "stub_complex64_ndarray_set_slice"
