...
CAMLprim value FUNCTION (stub, slide_native) (
  ...
  FUNCTION (c, slide) (X_data, Y_data, m, n, o, ofsx_m, incx_m, incx_n, incy_m, incy_n);

  return Val_unit;
}


CAMLprim value FUNCTION (stub, slide_byte) (value * argv, int argn) {
  return FUNCTION (stub, slide_native) (
