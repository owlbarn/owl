 ...
 * The function computed is  y0(x)  -  2 * log(x) * j0(x) / OWL_PI,
 * whose value at x = 0 is  2 * ( log(0.5) + EUL ) / OWL_PI
 * = 0.073804295108687225.
 */

/*
 * #define OWL_PI_4 .78539816339744830962
