...
value owl_stub_3_cblas_srotmg(value x23, value x22, value x21,
                                   value x20, value x19)
{
...
value owl_stub_4_cblas_drotmg(value x36, value x35, value x34,
                                   value x33, value x32)
{
...
value owl_stub_6_cblas_drot_byte7(value* argv, int argc)
{
   ...
   value x108 = argv[0];
   return
     owl_stub_6_cblas_drot(x108, x107, x106, x105, x104, x103, x102);
}
value owl_stub_7_cblas_sswap(value x113, value x112, value x111,
                                  value x110, value x109)
{
...
value owl_stub_8_cblas_dswap(value x130, value x129, value x128,
                                  value x127, value x126)
{
...
value owl_stub_9_cblas_cswap(value x147, value x146, value x145,
...
value owl_stub_10_cblas_zswap(value x164, value x163, value x162,
...
value owl_stub_11_cblas_sscal(value x180, value x179, value x178,
                                   value x177)
{
...
value owl_stub_12_cblas_dscal(value x195, value x194, value x193,
                                   value x192)
{
...
value owl_stub_13_cblas_cscal(value x210, value x209, value x208,
                                   value x207)
{
...
value owl_stub_14_cblas_zscal(value x223, value x222, value x221,
                                   value x220)
{
...
value owl_stub_17_cblas_scopy(value x267, value x266, value x265,
                                   value x264, value x263)
{
...
value owl_stub_18_cblas_dcopy(value x284, value x283, value x282,
...
value owl_stub_19_cblas_ccopy(value x301, value x300, value x299,
...
value owl_stub_20_cblas_zcopy(value x318, value x317, value x316,
                                   value x315, value x314)
{
...
value owl_stub_21_cblas_saxpy(value x336, value x335, value x334,
                                   value x333, value x332, value x331)
{
...
value owl_stub_22_cblas_daxpy(value x363, value x362, value x361,
                                   value x360, value x359, value x358)
{
...
value owl_stub_23_cblas_caxpy(value x390, value x389, value x388,
                                   value x387, value x386, value x385)
{
...
value owl_stub_24_cblas_zaxpy(value x415, value x414, value x413,
                                   value x412, value x411, value x410)
{
...
value owl_stub_25_cblas_sdot(value x439, value x438, value x437,
...
value owl_stub_26_cblas_ddot(value x456, value x455, value x454,
                                  value x453, value x452)
{
...
value owl_stub_28_cblas_dsdot(value x500, value x499, value x498,
                                   value x497, value x496)
{
...
value owl_stub_29_cblas_cdotu_sub_byte6(value* argv, int argc)
{
   ...
   value x537 = argv[0];
   return
     owl_stub_29_cblas_cdotu_sub(x537, x536, x535, x534, x533, x532);
}
...
value owl_stub_30_cblas_cdotc_sub_byte6(value* argv, int argc)
{
   ...
   value x562 = argv[0];
   return
     owl_stub_30_cblas_cdotc_sub(x562, x561, x560, x559, x558, x557);
}
...
value owl_stub_31_cblas_zdotu_sub_byte6(value* argv, int argc)
{
   ...
   value x587 = argv[0];
   return
     owl_stub_31_cblas_zdotu_sub(x587, x586, x585, x584, x583, x582);
}
...
value owl_stub_32_cblas_zdotc_sub_byte6(value* argv, int argc)
{
   ...
   value x612 = argv[0];
   return
     owl_stub_32_cblas_zdotc_sub(x612, x611, x610, x609, x608, x607);
}
...
value owl_stub_45_cblas_sgemv(value x756, value x755, value x754,
                                   value x753, value x752, value x751,
...
value owl_stub_45_cblas_sgemv_byte12(value* argv, int argc)
{
   ...
   value x799 = argv[0];
   return
     owl_stub_45_cblas_sgemv(x799, x798, x797, x796, x795, x794,
                                  x793, x792, x791, x790, x789, x788);
}
value owl_stub_46_cblas_dgemv(value x811, value x810, value x809,
                                   value x808, value x807, value x806,
                                   value x805, value x804, value x803,
                                   value x802, value x801, value x800)
{
...
value owl_stub_46_cblas_dgemv_byte12(value* argv, int argc)
{
   ...
   value x854 = argv[0];
   return
     owl_stub_46_cblas_dgemv(x854, x853, x852, x851, x850, x849,
                                  x848, x847, x846, x845, x844, x843);
}
value owl_stub_47_cblas_cgemv(value x866, value x865, value x864,
                                   value x863, value x862, value x861,
...
value owl_stub_47_cblas_cgemv_byte12(value* argv, int argc)
{
   ...
   value x905 = argv[0];
   return
     owl_stub_47_cblas_cgemv(x905, x904, x903, x902, x901, x900,
                                  x899, x898, x897, x896, x895, x894);
}
value owl_stub_48_cblas_zgemv(value x917, value x916, value x915,
                                   value x914, value x913, value x912,
                                   value x911, value x910, value x909,
                                   value x908, value x907, value x906)
{
...
value owl_stub_48_cblas_zgemv_byte12(value* argv, int argc)
{
   ...
   value x956 = argv[0];
   return
     owl_stub_48_cblas_zgemv(x956, x955, x954, x953, x952, x951,
                                  x950, x949, x948, x947, x946, x945);
}
value owl_stub_49_cblas_sgbmv(value x970, value x969, value x968,
                                   value x967, value x966, value x965,
                                   value x964, value x963, value x962,
                                   value x961, value x960, value x959,
...
value owl_stub_49_cblas_sgbmv_byte14(value* argv, int argc)
{
   ...
   value x1021 = argv[0];
   return
     owl_stub_49_cblas_sgbmv(x1021, x1020, x1019, x1018, x1017,
                                  x1016, x1015, x1014, x1013, x1012,
                                  x1011, x1010, x1009, x1008);
}
...
value owl_stub_50_cblas_dgbmv_byte14(value* argv, int argc)
{
   ...
   value x1086 = argv[0];
   return
     owl_stub_50_cblas_dgbmv(x1086, x1085, x1084, x1083, x1082,
                                  x1081, x1080, x1079, x1078, x1077,
                                  x1076, x1075, x1074, x1073);
}
...
value owl_stub_51_cblas_cgbmv_byte14(value* argv, int argc)
{
   ...
   value x1147 = argv[0];
   return
     owl_stub_51_cblas_cgbmv(x1147, x1146, x1145, x1144, x1143,
                                  x1142, x1141, x1140, x1139, x1138,
                                  x1137, x1136, x1135, x1134);
}
...
value owl_stub_52_cblas_zgbmv_byte14(value* argv, int argc)
{
   ...
   value x1208 = argv[0];
   return
     owl_stub_52_cblas_zgbmv(x1208, x1207, x1206, x1205, x1204,
                                  x1203, x1202, x1201, x1200, x1199,
                                  x1198, x1197, x1196, x1195);
}
...
value owl_stub_53_cblas_strmv_byte9(value* argv, int argc)
{
   ...
   value x1250 = argv[0];
   return
     owl_stub_53_cblas_strmv(x1250, x1249, x1248, x1247, x1246,
                                  x1245, x1244, x1243, x1242);
}
...
value owl_stub_54_cblas_dtrmv_byte9(value* argv, int argc)
{
   ...
   value x1292 = argv[0];
   return
     owl_stub_54_cblas_dtrmv(x1292, x1291, x1290, x1289, x1288,
                                  x1287, x1286, x1285, x1284);
}
...
value owl_stub_55_cblas_ctrmv_byte9(value* argv, int argc)
{
   ...
   value x1334 = argv[0];
   return
     owl_stub_55_cblas_ctrmv(x1334, x1333, x1332, x1331, x1330,
                                  x1329, x1328, x1327, x1326);
}
...
value owl_stub_56_cblas_ztrmv_byte9(value* argv, int argc)
{
   ...
   value x1376 = argv[0];
   return
     owl_stub_56_cblas_ztrmv(x1376, x1375, x1374, x1373, x1372,
                                  x1371, x1370, x1369, x1368);
}
...
value owl_stub_57_cblas_stbmv_byte10(value* argv, int argc)
{
   ...
   value x1423 = argv[0];
   return
     owl_stub_57_cblas_stbmv(x1423, x1422, x1421, x1420, x1419,
                                  x1418, x1417, x1416, x1415, x1414);
}
...
value owl_stub_58_cblas_dtbmv_byte10(value* argv, int argc)
{
   ...
   value x1470 = argv[0];
   return
     owl_stub_58_cblas_dtbmv(x1470, x1469, x1468, x1467, x1466,
                                  x1465, x1464, x1463, x1462, x1461);
}
...
value owl_stub_59_cblas_ctbmv_byte10(value* argv, int argc)
{
   ...
   value x1517 = argv[0];
   return
     owl_stub_59_cblas_ctbmv(x1517, x1516, x1515, x1514, x1513,
                                  x1512, x1511, x1510, x1509, x1508);
}
...
value owl_stub_60_cblas_ztbmv_byte10(value* argv, int argc)
{
   ...
   value x1564 = argv[0];
   return
     owl_stub_60_cblas_ztbmv(x1564, x1563, x1562, x1561, x1560,
                                  x1559, x1558, x1557, x1556, x1555);
}
...
value owl_stub_61_cblas_stpmv_byte8(value* argv, int argc)
{
   ...
   value x1601 = argv[0];
   return
     owl_stub_61_cblas_stpmv(x1601, x1600, x1599, x1598, x1597,
                                  x1596, x1595, x1594);
}
...
value owl_stub_62_cblas_dtpmv_byte8(value* argv, int argc)
{
   ...
   value x1638 = argv[0];
   return
     owl_stub_62_cblas_dtpmv(x1638, x1637, x1636, x1635, x1634,
                                  x1633, x1632, x1631);
}
...
value owl_stub_63_cblas_ctpmv_byte8(value* argv, int argc)
{
   ...
   value x1675 = argv[0];
   return
     owl_stub_63_cblas_ctpmv(x1675, x1674, x1673, x1672, x1671,
                                  x1670, x1669, x1668);
}
...
value owl_stub_64_cblas_ztpmv_byte8(value* argv, int argc)
{
   ...
   value x1712 = argv[0];
   return
     owl_stub_64_cblas_ztpmv(x1712, x1711, x1710, x1709, x1708,
                                  x1707, x1706, x1705);
}
...
value owl_stub_65_cblas_strsv_byte9(value* argv, int argc)
{
   ...
   value x1754 = argv[0];
   return
     owl_stub_65_cblas_strsv(x1754, x1753, x1752, x1751, x1750,
                                  x1749, x1748, x1747, x1746);
}
...
value owl_stub_66_cblas_dtrsv_byte9(value* argv, int argc)
{
   ...
   value x1796 = argv[0];
   return
     owl_stub_66_cblas_dtrsv(x1796, x1795, x1794, x1793, x1792,
                                  x1791, x1790, x1789, x1788);
}
...
value owl_stub_67_cblas_ctrsv_byte9(value* argv, int argc)
{
   ...
   value x1838 = argv[0];
   return
     owl_stub_67_cblas_ctrsv(x1838, x1837, x1836, x1835, x1834,
                                  x1833, x1832, x1831, x1830);
}
...
value owl_stub_68_cblas_ztrsv_byte9(value* argv, int argc)
{
   ...
   value x1880 = argv[0];
   return
     owl_stub_68_cblas_ztrsv(x1880, x1879, x1878, x1877, x1876,
                                  x1875, x1874, x1873, x1872);
}
...
value owl_stub_69_cblas_stbsv_byte10(value* argv, int argc)
{
   ...
   value x1927 = argv[0];
   return
     owl_stub_69_cblas_stbsv(x1927, x1926, x1925, x1924, x1923,
                                  x1922, x1921, x1920, x1919, x1918);
}
...
value owl_stub_70_cblas_dtbsv_byte10(value* argv, int argc)
{
   ...
   value x1974 = argv[0];
   return
     owl_stub_70_cblas_dtbsv(x1974, x1973, x1972, x1971, x1970,
                                  x1969, x1968, x1967, x1966, x1965);
}
...
value owl_stub_71_cblas_ctbsv_byte10(value* argv, int argc)
{
   ...
   value x2021 = argv[0];
   return
     owl_stub_71_cblas_ctbsv(x2021, x2020, x2019, x2018, x2017,
...
value owl_stub_72_cblas_ztbsv_byte10(value* argv, int argc)
{
   ...
   value x2068 = argv[0];
   return
     owl_stub_72_cblas_ztbsv(x2068, x2067, x2066, x2065, x2064,
                                  x2063, x2062, x2061, x2060, x2059);
}
...
value owl_stub_73_cblas_stpsv_byte8(value* argv, int argc)
{
   ...
   value x2105 = argv[0];
   return
     owl_stub_73_cblas_stpsv(x2105, x2104, x2103, x2102, x2101,
                                  x2100, x2099, x2098);
}
...
value owl_stub_74_cblas_dtpsv_byte8(value* argv, int argc)
{
   ...
   value x2142 = argv[0];
   return
     owl_stub_74_cblas_dtpsv(x2142, x2141, x2140, x2139, x2138,
                                  x2137, x2136, x2135);
}
...
value owl_stub_75_cblas_ctpsv_byte8(value* argv, int argc)
{
   ...
   value x2179 = argv[0];
   return
     owl_stub_75_cblas_ctpsv(x2179, x2178, x2177, x2176, x2175,
                                  x2174, x2173, x2172);
}
...
value owl_stub_76_cblas_ztpsv_byte8(value* argv, int argc)
{
   ...
   value x2216 = argv[0];
   return
     owl_stub_76_cblas_ztpsv(x2216, x2215, x2214, x2213, x2212,
                                  x2211, x2210, x2209);
}
...
value owl_stub_77_cblas_ssymv_byte11(value* argv, int argc)
{
   ...
   value x2266 = argv[0];
   return
     owl_stub_77_cblas_ssymv(x2266, x2265, x2264, x2263, x2262,
                                  x2261, x2260, x2259, x2258, x2257,
                                  x2256);
}
...
value owl_stub_78_cblas_dsymv_byte11(value* argv, int argc)
{
   ...
   value x2316 = argv[0];
   return
     owl_stub_78_cblas_dsymv(x2316, x2315, x2314, x2313, x2312,
...
value owl_stub_79_cblas_ssbmv_byte12(value* argv, int argc)
{
   ...
   value x2371 = argv[0];
   return
     owl_stub_79_cblas_ssbmv(x2371, x2370, x2369, x2368, x2367,
...
value owl_stub_80_cblas_dsbmv_byte12(value* argv, int argc)
{
   ...
   value x2426 = argv[0];
   return
     owl_stub_80_cblas_dsbmv(x2426, x2425, x2424, x2423, x2422,
                                  x2421, x2420, x2419, x2418, x2417,
                                  x2416, x2415);
}
...
value owl_stub_81_cblas_sspmv_byte10(value* argv, int argc)
{
   ...
   value x2471 = argv[0];
   return
     owl_stub_81_cblas_sspmv(x2471, x2470, x2469, x2468, x2467,
                                  x2466, x2465, x2464, x2463, x2462);
}
...
value owl_stub_82_cblas_dspmv_byte10(value* argv, int argc)
{
   ...
   value x2516 = argv[0];
   return
     owl_stub_82_cblas_dspmv(x2516, x2515, x2514, x2513, x2512,
                                  x2511, x2510, x2509, x2508, x2507);
}
...
value owl_stub_87_cblas_sspr_byte7(value* argv, int argc)
{
   ...
   value x2712 = argv[0];
   return
     owl_stub_87_cblas_sspr(x2712, x2711, x2710, x2709, x2708, x2707,
                                 x2706);
}
...
value owl_stub_88_cblas_dspr_byte7(value* argv, int argc)
{
   ...
   value x2744 = argv[0];
   return
     owl_stub_88_cblas_dspr(x2744, x2743, x2742, x2741, x2740, x2739,
                                 x2738);
}
...
value owl_stub_89_cblas_ssyr2_byte10(value* argv, int argc)
{
   ...
   value x2789 = argv[0];
   return
     owl_stub_89_cblas_ssyr2(x2789, x2788, x2787, x2786, x2785,
                                  x2784, x2783, x2782, x2781, x2780);
}
...
value owl_stub_90_cblas_dsyr2_byte10(value* argv, int argc)
{
   ...
   value x2834 = argv[0];
   return
     owl_stub_90_cblas_dsyr2(x2834, x2833, x2832, x2831, x2830,
                                  x2829, x2828, x2827, x2826, x2825);
}
...
value owl_stub_91_cblas_sspr2_byte9(value* argv, int argc)
{
   ...
   value x2874 = argv[0];
   return
     owl_stub_91_cblas_sspr2(x2874, x2873, x2872, x2871, x2870,
                                  x2869, x2868, x2867, x2866);
}
...
value owl_stub_92_cblas_dspr2_byte9(value* argv, int argc)
{
   ...
   value x2914 = argv[0];
   return
     owl_stub_92_cblas_dspr2(x2914, x2913, x2912, x2911, x2910,
                                  x2909, x2908, x2907, x2906);
}
...
value owl_stub_93_cblas_chemv_byte11(value* argv, int argc)
{
   ...
   value x2960 = argv[0];
   return
     owl_stub_93_cblas_chemv(x2960, x2959, x2958, x2957, x2956,
                                  x2955, x2954, x2953, x2952, x2951,
                                  x2950);
}
...
value owl_stub_94_cblas_zhemv_byte11(value* argv, int argc)
{
   ...
   value x3006 = argv[0];
   return
     owl_stub_94_cblas_zhemv(x3006, x3005, x3004, x3003, x3002,
                                  x3001, x3000, x2999, x2998, x2997,
                                  x2996);
}
...
value owl_stub_95_cblas_chbmv_byte12(value* argv, int argc)
{
   ...
   value x3057 = argv[0];
   return
     owl_stub_95_cblas_chbmv(x3057, x3056, x3055, x3054, x3053,
                                  x3052, x3051, x3050, x3049, x3048,
                                  x3047, x3046);
}
...
value owl_stub_96_cblas_zhbmv_byte12(value* argv, int argc)
{
   ...
   value x3108 = argv[0];
   return
     owl_stub_96_cblas_zhbmv(x3108, x3107, x3106, x3105, x3104,
                                  x3103, x3102, x3101, x3100, x3099,
                                  x3098, x3097);
}
...
value owl_stub_97_cblas_chpmv_byte10(value* argv, int argc)
{
   ...
   value x3149 = argv[0];
   return
     owl_stub_97_cblas_chpmv(x3149, x3148, x3147, x3146, x3145,
                                  x3144, x3143, x3142, x3141, x3140);
}
...
value owl_stub_98_cblas_zhpmv_byte10(value* argv, int argc)
{
   ...
   value x3190 = argv[0];
   return
     owl_stub_98_cblas_zhpmv(x3190, x3189, x3188, x3187, x3186,
                                  x3185, x3184, x3183, x3182, x3181);
}
...
value owl_stub_99_cblas_cgeru_byte10(value* argv, int argc)
{
   ...
   value x3233 = argv[0];
   return
     owl_stub_99_cblas_cgeru(x3233, x3232, x3231, x3230, x3229,
                                  x3228, x3227, x3226, x3225, x3224);
}
...
value owl_stub_100_cblas_zgeru_byte10(value* argv, int argc)
{
   ...
   value x3276 = argv[0];
   return
     owl_stub_100_cblas_zgeru(x3276, x3275, x3274, x3273, x3272,
                                   x3271, x3270, x3269, x3268, x3267);
}
...
value owl_stub_101_cblas_cgerc_byte10(value* argv, int argc)
{
   ...
   value x3319 = argv[0];
   return
     owl_stub_101_cblas_cgerc(x3319, x3318, x3317, x3316, x3315,
                                   x3314, x3313, x3312, x3311, x3310);
}
...
value owl_stub_102_cblas_zgerc_byte10(value* argv, int argc)
{
   ...
   value x3362 = argv[0];
   return
     owl_stub_102_cblas_zgerc(x3362, x3361, x3360, x3359, x3358,
                                   x3357, x3356, x3355, x3354, x3353);
}
...
value owl_stub_103_cblas_cher_byte8(value* argv, int argc)
{
   ...
   value x3399 = argv[0];
   return
     owl_stub_103_cblas_cher(x3399, x3398, x3397, x3396, x3395,
                                  x3394, x3393, x3392);
}
...
value owl_stub_104_cblas_zher_byte8(value* argv, int argc)
{
   ...
   value x3436 = argv[0];
   return
     owl_stub_104_cblas_zher(x3436, x3435, x3434, x3433, x3432,
                                  x3431, x3430, x3429);
}
...
value owl_stub_105_cblas_chpr_byte7(value* argv, int argc)
{
   ...
   value x3468 = argv[0];
   return
     owl_stub_105_cblas_chpr(x3468, x3467, x3466, x3465, x3464,
                                  x3463, x3462);
}
...
value owl_stub_106_cblas_zhpr_byte7(value* argv, int argc)
{
   ...
   value x3500 = argv[0];
   return
     owl_stub_106_cblas_zhpr(x3500, x3499, x3498, x3497, x3496,
                                  x3495, x3494);
}
...
value owl_stub_107_cblas_cher2_byte10(value* argv, int argc)
{
   ...
   value x3543 = argv[0];
   return
     owl_stub_107_cblas_cher2(x3543, x3542, x3541, x3540, x3539,
                                   x3538, x3537, x3536, x3535, x3534);
}
...
value owl_stub_108_cblas_zher2_byte10(value* argv, int argc)
{
   ...
   value x3586 = argv[0];
   return
     owl_stub_108_cblas_zher2(x3586, x3585, x3584, x3583, x3582,
                                   x3581, x3580, x3579, x3578, x3577);
}
...
value owl_stub_109_cblas_chpr2_byte9(value* argv, int argc)
{
   ...
   value x3624 = argv[0];
   return
     owl_stub_109_cblas_chpr2(x3624, x3623, x3622, x3621, x3620,
                                   x3619, x3618, x3617, x3616);
}
...
value owl_stub_110_cblas_zhpr2_byte9(value* argv, int argc)
{
   ...
   value x3662 = argv[0];
   return
     owl_stub_110_cblas_zhpr2(x3662, x3661, x3660, x3659, x3658,
                                   x3657, x3656, x3655, x3654);
}
...
value owl_stub_111_cblas_sgemm_byte14(value* argv, int argc)
{
   ...
   value x3727 = argv[0];
   return
     owl_stub_111_cblas_sgemm(x3727, x3726, x3725, x3724, x3723,
                                   x3722, x3721, x3720, x3719, x3718,
                                   x3717, x3716, x3715, x3714);
}
...
value owl_stub_112_cblas_dgemm_byte14(value* argv, int argc)
{
   ...
   value x3792 = argv[0];
   return
     owl_stub_112_cblas_dgemm(x3792, x3791, x3790, x3789, x3788,
                                   x3787, x3786, x3785, x3784, x3783,
                                   x3782, x3781, x3780, x3779);
}
...
value owl_stub_113_cblas_cgemm_byte14(value* argv, int argc)
{
   ...
   value x3853 = argv[0];
   return
     owl_stub_113_cblas_cgemm(x3853, x3852, x3851, x3850, x3849,
                                   x3848, x3847, x3846, x3845, x3844,
                                   x3843, x3842, x3841, x3840);
}
...
value owl_stub_114_cblas_zgemm_byte14(value* argv, int argc)
{
   ...
   value x3914 = argv[0];
   return
     owl_stub_114_cblas_zgemm(x3914, x3913, x3912, x3911, x3910,
                                   x3909, x3908, x3907, x3906, x3905,
                                   x3904, x3903, x3902, x3901);
}
...
value owl_stub_115_cblas_ssymm_byte13(value* argv, int argc)
{
   ...
   value x3974 = argv[0];
   return
     owl_stub_115_cblas_ssymm(x3974, x3973, x3972, x3971, x3970,
                                   x3969, x3968, x3967, x3966, x3965,
                                   x3964, x3963, x3962);
}
...
value owl_stub_116_cblas_dsymm_byte13(value* argv, int argc)
{
   ...
   value x4034 = argv[0];
   return
     owl_stub_116_cblas_dsymm(x4034, x4033, x4032, x4031, x4030,
                                   x4029, x4028, x4027, x4026, x4025,
                                   x4024, x4023, x4022);
}
...
value owl_stub_117_cblas_csymm_byte13(value* argv, int argc)
{
   ...
   value x4090 = argv[0];
   return
     owl_stub_117_cblas_csymm(x4090, x4089, x4088, x4087, x4086,
                                   x4085, x4084, x4083, x4082, x4081,
                                   x4080, x4079, x4078);
}
...
value owl_stub_118_cblas_zsymm_byte13(value* argv, int argc)
{
   ...
   value x4146 = argv[0];
   return
     owl_stub_118_cblas_zsymm(x4146, x4145, x4144, x4143, x4142,
                                   x4141, x4140, x4139, x4138, x4137,
                                   x4136, x4135, x4134);
}
...
value owl_stub_119_cblas_ssyrk_byte11(value* argv, int argc)
{
   ...
   value x4198 = argv[0];
   return
     owl_stub_119_cblas_ssyrk(x4198, x4197, x4196, x4195, x4194,
                                   x4193, x4192, x4191, x4190, x4189,
                                   x4188);
}
...
value owl_stub_120_cblas_dsyrk_byte11(value* argv, int argc)
{
   ...
   value x4250 = argv[0];
   return
     owl_stub_120_cblas_dsyrk(x4250, x4249, x4248, x4247, x4246,
                                   x4245, x4244, x4243, x4242, x4241,
                                   x4240);
}
...
value owl_stub_121_cblas_csyrk_byte11(value* argv, int argc)
{
   ...
   value x4298 = argv[0];
   return
     owl_stub_121_cblas_csyrk(x4298, x4297, x4296, x4295, x4294,
                                   x4293, x4292, x4291, x4290, x4289,
                                   x4288);
}
...
value owl_stub_122_cblas_zsyrk_byte11(value* argv, int argc)
{
   ...
   value x4346 = argv[0];
   return
     owl_stub_122_cblas_zsyrk(x4346, x4345, x4344, x4343, x4342,
                                   x4341, x4340, x4339, x4338, x4337,
                                   x4336);
}
...
value owl_stub_123_cblas_ssyr2k_byte13(value* argv, int argc)
{
   ...
   value x4406 = argv[0];
   return
     owl_stub_123_cblas_ssyr2k(x4406, x4405, x4404, x4403, x4402,
                                    x4401, x4400, x4399, x4398, x4397,
                                    x4396, x4395, x4394);
}
...
value owl_stub_124_cblas_dsyr2k_byte13(value* argv, int argc)
{
   ...
   value x4466 = argv[0];
   return
     owl_stub_124_cblas_dsyr2k(x4466, x4465, x4464, x4463, x4462,
                                    x4461, x4460, x4459, x4458, x4457,
                                    x4456, x4455, x4454);
}
...
value owl_stub_125_cblas_csyr2k_byte13(value* argv, int argc)
{
   ...
   value x4522 = argv[0];
   return
     owl_stub_125_cblas_csyr2k(x4522, x4521, x4520, x4519, x4518,
                                    x4517, x4516, x4515, x4514, x4513,
                                    x4512, x4511, x4510);
}
...
value owl_stub_126_cblas_zsyr2k_byte13(value* argv, int argc)
{
   ...
   value x4578 = argv[0];
   return
     owl_stub_126_cblas_zsyr2k(x4578, x4577, x4576, x4575, x4574,
...
value owl_stub_127_cblas_strmm_byte12(value* argv, int argc)
{
   ...
   value x4635 = argv[0];
   return
     owl_stub_127_cblas_strmm(x4635, x4634, x4633, x4632, x4631,
...
value owl_stub_128_cblas_dtrmm_byte12(value* argv, int argc)
{
   ...
   value x4692 = argv[0];
   return
     owl_stub_128_cblas_dtrmm(x4692, x4691, x4690, x4689, x4688,
                                   x4687, x4686, x4685, x4684, x4683,
                                   x4682, x4681);
}
...
value owl_stub_129_cblas_ctrmm_byte12(value* argv, int argc)
{
   ...
   value x4747 = argv[0];
   return
     owl_stub_129_cblas_ctrmm(x4747, x4746, x4745, x4744, x4743,
                                   x4742, x4741, x4740, x4739, x4738,
                                   x4737, x4736);
}
...
value owl_stub_130_cblas_ztrmm_byte12(value* argv, int argc)
{
   ...
   value x4802 = argv[0];
   return
     owl_stub_130_cblas_ztrmm(x4802, x4801, x4800, x4799, x4798,
                                   x4797, x4796, x4795, x4794, x4793,
                                   x4792, x4791);
}
...
value owl_stub_131_cblas_strsm_byte12(value* argv, int argc)
{
   ...
   value x4859 = argv[0];
   return
     owl_stub_131_cblas_strsm(x4859, x4858, x4857, x4856, x4855,
                                   x4854, x4853, x4852, x4851, x4850,
                                   x4849, x4848);
}
...
value owl_stub_132_cblas_dtrsm_byte12(value* argv, int argc)
{
   ...
   value x4916 = argv[0];
   return
     owl_stub_132_cblas_dtrsm(x4916, x4915, x4914, x4913, x4912,
                                   x4911, x4910, x4909, x4908, x4907,
                                   x4906, x4905);
}
...
value owl_stub_133_cblas_ctrsm_byte12(value* argv, int argc)
{
   ...
   value x4971 = argv[0];
   return
     owl_stub_133_cblas_ctrsm(x4971, x4970, x4969, x4968, x4967,
                                   x4966, x4965, x4964, x4963, x4962,
                                   x4961, x4960);
}
...
value owl_stub_134_cblas_ztrsm_byte12(value* argv, int argc)
{
   ...
   value x5026 = argv[0];
   return
     owl_stub_134_cblas_ztrsm(x5026, x5025, x5024, x5023, x5022,
                                   x5021, x5020, x5019, x5018, x5017,
                                   x5016, x5015);
}
...
value owl_stub_135_cblas_chemm_byte13(value* argv, int argc)
{
   ...
   value x5082 = argv[0];
   return
     owl_stub_135_cblas_chemm(x5082, x5081, x5080, x5079, x5078,
                                   x5077, x5076, x5075, x5074, x5073,
                                   x5072, x5071, x5070);
}
...
value owl_stub_136_cblas_zhemm_byte13(value* argv, int argc)
{
   ...
   value x5138 = argv[0];
   return
     owl_stub_136_cblas_zhemm(x5138, x5137, x5136, x5135, x5134,
                                   x5133, x5132, x5131, x5130, x5129,
                                   x5128, x5127, x5126);
}
...
value owl_stub_137_cblas_cherk_byte11(value* argv, int argc)
{
   ...
   value x5190 = argv[0];
   return
     owl_stub_137_cblas_cherk(x5190, x5189, x5188, x5187, x5186,
                                   x5185, x5184, x5183, x5182, x5181,
                                   x5180);
}
...
value owl_stub_138_cblas_zherk_byte11(value* argv, int argc)
{
   ...
   value x5242 = argv[0];
   return
     owl_stub_138_cblas_zherk(x5242, x5241, x5240, x5239, x5238,
...
value owl_stub_139_cblas_cher2k_byte13(value* argv, int argc)
{
   ...
   value x5300 = argv[0];
   return
     owl_stub_139_cblas_cher2k(x5300, x5299, x5298, x5297, x5296,
                                    x5295, x5294, x5293, x5292, x5291,
                                    x5290, x5289, x5288);
}
...
value owl_stub_140_cblas_zher2k_byte13(value* argv, int argc)
{
   ...
   value x5358 = argv[0];
   return
     owl_stub_140_cblas_zher2k(x5358, x5357, x5356, x5355, x5354,
                                    x5353, x5352, x5351, x5350, x5349,
                                    x5348, x5347, x5346);
}
