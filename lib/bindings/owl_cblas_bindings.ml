...
(* auto-generated cblas interface file, timestamp:1497624551 *)
...
module Bindings (F : Cstubs.FOREIGN) = struct
  ...
  let cblas_srotm = foreign "cblas_srotm" (int @-> ptr float @-> int @-> ptr float @-> int @-> ptr float @-> returning void)
  ...
  let cblas_drotm = foreign "cblas_drotm" (int @-> ptr double @-> int @-> ptr double @-> int @-> ptr double @-> returning void)
  ...
  let cblas_zher = foreign "cblas_zher" (int @-> int @-> int @-> double @-> ptr complex64 @-> int @-> ptr complex64 @-> int @-> returning void)

  let cblas_zhpr = foreign "cblas_zhpr" (int @-> int @-> int @-> double @-> ptr complex64 @-> int @-> ptr complex64 @-> returning void)
  ...
  let cblas_zher2k = foreign "cblas_zher2k" (int @-> int @-> int @-> int @-> int @-> ptr complex64 @-> ptr complex64 @-> int @-> ptr complex64 @-> int @-> double @-> ptr complex64 @-> int @-> returning void)
