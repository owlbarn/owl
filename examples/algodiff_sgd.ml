#!/usr/bin/env owl
(* This example demonstrates how to write a stochastic gradient descent
   algorithm from scratch using Algodiff module. The more advanced algorithms
   can also be build using the similar way.
 *)
